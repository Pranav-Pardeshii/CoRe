...
division = st.selectbox("Select preferred division/location :", divisions = ["Amravati Division", "Aurangabad Division", "Mumbai Division", "Nagpur Division", "Nashik Division", "Pune Division"])
